...
const miniApps = [
  { name: 'Darood Community', href: 'https://durood.vercel.app/', icon: HandHelping, 'data-ai-hint': 'community prayer', external: true },
  ...
  return (
    <div className="p-4 grid grid-cols-3 gap-4">
      {miniApps.map((app) => {
        ...
        return (
            <Link href={app.href} key={app.name} className="group" {...linkProps}>
